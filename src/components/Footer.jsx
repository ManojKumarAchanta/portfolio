...
const Footer = () => {
  return (
    <footer className="w-full bg-gray-900 text-gray-400 text-center py-6">
      {/* <hr className="bg-gray-800 mb-2"/> */}
      <div className="flex mb-2 gap-6 justify-center items-center">
        <a
        ...
        >
          <svg
            width="24" // Set minimum width
            height="24" // Set minimum height
            viewBox="0 0 95 111"
            fill="none"
